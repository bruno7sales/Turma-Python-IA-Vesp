...
if __name__ == '__main__':
    ...
    while True:
        ...
        if opcao == '1':
            ...
            titular = input('Informa o nome do titular: ')

            try:
                # pesquisa pelo correntista
                for i in range(len(correntista)):
                            ...
                            match operacao:
                                ...
                                case '3':
                                    ...
                                    if valor < saldo:
                                        ...
                                        print('Saque atual: R$ {saldo:,.2f}')
                                    else:
                                        print('Nã foi possível efetuar o saque.')
                                        continue
                    ...
                    #avança para o próximo loop caso o nome não seja encontrado
                        ...
                        continue
                    #mensagem de nome nao encontrado
            except:
